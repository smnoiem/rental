               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                  <div class="inner-box">
                     <div class="dashboard-box">
                        <h2 class="dashbord-title">Edit Post Detail</h2>
                     </div>
                     <div class="dashboard-wrapper">
        		        <form action="admin-product-edit-process.php" method="POST"  enctype="multipart/form-data" onsubmit="return validateAdForm()">
